  ...
  return (
    <section className="relative min-h-[520px] lg:min-h-[560px] flex items-center overflow-hidden">
      ...
      <div className="absolute inset-0">
        <img
          src={heroImage}
          alt="Indian family with child enjoying quality time together"
      ...
      <div className="container relative z-10 py-16 lg:py-24">
        <div className="max-w-xl">
          <motion.h1
            ...
            className="text-4xl lg:text-5xl font-display font-bold text-secondary-foreground leading-tight mb-4"
          >
          ...
          <motion.p
            ...
            className="text-lg text-secondary-foreground/90 mb-8"
          >
            Early childhood intervention services and support for young children and families across India
          </motion.p>
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
